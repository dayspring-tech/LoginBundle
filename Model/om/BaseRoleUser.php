...
abstract class BaseRoleUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Dayspring\\LoginBundle\\Model\\RoleUserPeer';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = RoleUserPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RoleUserQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RoleUserPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(RoleUserPeer::ROLE_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['RoleUser'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RoleUser'][serialize($this->getPrimaryKey())] = true;
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aSecurityRole) {
                $result['SecurityRole'] = $this->aSecurityRole->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     * @throws PropelException
     */
    public function getSecurityRole(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSecurityRole === null && ($this->role_id !== null) && $doQuery) {
            $this->aSecurityRole = SecurityRoleQuery::create()->findPk($this->role_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSecurityRole->addRoleUsers($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aSecurityRole instanceof Persistent) {
              $this->aSecurityRole->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(RoleUserPeer::DEFAULT_STRING_FORMAT);
    }
