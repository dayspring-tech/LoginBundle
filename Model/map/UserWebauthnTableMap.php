...
/**
 * This class defines the structure of the 'users_webauthn' table.
 *
 *
 *
 ...
 */
class UserWebauthnTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'vendor.dayspring-tech.login-bundle.Model.map.UserWebauthnTableMap';
    ...
    {
        // attributes
        $this->setName('users_webauthn');
        $this->setPhpName('UserWebauthn');
        $this->setClassname('Dayspring\\LoginBundle\\Model\\UserWebauthn');
